        ...
        <div className="min-h-screen flex flex-col items-center justify-center bg-[#F8FAFC] relative overflow-hidden font-sans p-4">
            ...
            <div className="absolute inset-0 overflow-hidden pointer-events-none">
                ...
                <motion.div
                    ...
                    className="absolute bottom-[-20%] right-[-10%] w-[600px] h-[600px] bg-blue-200/20 rounded-full blur-[80px]"
                />
            ...
            <motion.div
                ...
                className="relative z-10 mb-6 flex items-center gap-6 text-xs text-gray-500"
            >
                <div className="flex items-center gap-1.5">
                    <Users size={14} className="text-indigo-500" />
                    <span><strong className="text-gray-700">50K+</strong> Learners</span>
                </div>
                <div className="flex items-center gap-1.5">
                    <BookOpen size={14} className="text-indigo-500" />
                    <span><strong className="text-gray-700">200+</strong> Courses</span>
                </div>
                <div className="flex items-center gap-1.5">
                    <Award size={14} className="text-indigo-500" />
                    <span><strong className="text-gray-700">Free</strong> Certificates</span>
                </div>
            </motion.div>
            ...
            >
                ...
                <div className="text-center mb-8">
                    <h2 className="text-2xl font-bold text-gray-900 mb-2">Create your Upskill account</h2>
                    <p className="text-gray-500 text-sm">Join to personalize your AI learning path.</p>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                    <div className="space-y-2">
                        <label className="text-sm font-semibold text-gray-700 block" htmlFor="fullName">Full Name</label>
                        <input
                            type="text"
                            id="fullName"
                    ...
                    <div className="space-y-2">
                        <label className="text-sm font-semibold text-gray-700 block" htmlFor="email">Email Address</label>
                        <input
                            type="email"
                            id="email"
                    ...
                    <div className="space-y-2">
                        <label className="text-sm font-semibold text-gray-700 block" htmlFor="password">Password</label>
                ...
                <div className="mt-8 text-center">
                    <div className="relative mb-6">
                        ...
                        <div className="relative flex justify-center text-xs uppercase">
                            <span className="bg-white px-3 text-gray-400 font-medium tracking-wide">or register with</span>
                        </div>
                    </div>
                    ...
                    <p className="mt-8 text-sm text-gray-500">
                        ...
                        <Link to="/upskill/login" className="ml-1 font-bold text-indigo-600 hover:text-indigo-700 hover:underline">
                            Sign In
                        </Link>
                    </p>
                </div>
...
export default UpskillRegistration;

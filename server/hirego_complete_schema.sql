-- ============================================================
-- HIREGO AI - COMPLETE UNIFIED DATABASE SCHEMA
-- 42 Tables | Full PK/FK | Indexes | RLS | Public Policies
...
-- ========================
-- 4. CANDIDATE_PROGRESS (Upskill Learning)
-- ========================
...
-- ========================
-- 17. EMPLOYER_JOB_POSTS (Jobs Table)
-- ========================
...
-- ========================
CREATE TABLE IF NOT EXISTS employer_activity_log (
  id BIGINT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
  employer_id TEXT REFERENCES users(id) ON DELETE CASCADE,
  action TEXT NOT NULL,
  entity_type TEXT,
...
-- ========================
CREATE TABLE IF NOT EXISTS pay_per_hire_records (
  id BIGINT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
  employer_id TEXT REFERENCES users(id),
  candidate_id TEXT REFERENCES users(id),
  job_id BIGINT REFERENCES employer_job_posts(id),
